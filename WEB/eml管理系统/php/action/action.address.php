...
if($do=="add"){
	...
	$created_at = time();
	$sql="insert into `eml_address_list` (`id` ,`name` ,`sex` ,`phone` ,`tel` ,`email` ,`deparyment` ,`position` ,`address` ,`created_at` )
	values ('$id','$name','$sex','$phone','$tel','$email','$deparyment','$position','$address','$created_at');";	
